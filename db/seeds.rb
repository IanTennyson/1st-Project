...
ingredient2 = Ingredient.new({ 'name' => 'Gin', 'measure_id' => fifty_ml.id, 'price_per_ltr' => 15.0, 'is_alcoholic' => true, 'quantity' => 5, 'cost_price' => 0.0, 'sale_price' => 0.0, 'profit' => 0.0   })
ingredient2.save()
...
ingredient5 = Ingredient.new({ 'name' => 'Orange', 'measure_id' => fifty_ml.id, 'price_per_ltr' => 1.23, 'is_alcoholic' => false, 'quantity' => 10, 'cost_price' => 0.0, 'sale_price' => 0.0, 'profit' => 0.0  })
ingredient5.save()

ingredient6 = Ingredient.new({ 'name' => 'Cranberry', 'measure_id' => fifty_ml.id, 'price_per_ltr' => 1.98, 'is_alcoholic' => false, 'quantity' => 10, 'cost_price' => 0.0, 'sale_price' => 0.0, 'profit' => 0.0  })
ingredient6.save()
